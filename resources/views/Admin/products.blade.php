...
@section('page_content')
    <section class="px-5 md:px-12 lg:px-20 py-5 flex items-center justify-between">
        <div class="bg-white rounded-lg">
            <div class="text-2xl font-bold tracking-tight">Product Management</div>
        </div>
        <div x-data="{ modalOpen: false }">
            ...
            <div x-show="modalOpen" x-transition
                ...
                <div @click.outside="modalOpen = false"
                    ...
                    <form action="{{ route('products.store') }}" method="POST" class="my-5 grid grid-cols-12 gap-5"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="col-span-6">
                            <label for="" class=" text-neutral-800">Product ID</label>
                            <input type="text" name='product_id'
                                class="w-full bg-gray-50 focus:bg-white px-2 py-2 rounded-md" placeholder="BCC001" autofocus
                                required>
                        </div>
                        <div class="col-span-6">
                            <label for="" class=" text-neutral-800">Product Name</label>
                            <input type="text" name='product_name'
                                class="w-full bg-gray-50 focus:bg-white px-2 py-2 rounded-md"
                                placeholder="Affogato"autofocus required>
                        </div>
                        <div class="col-span-6">
                            <label for="" class=" text-neutral-800">Product Price</label>
                            <input type="text" name='product_price'
                                class="w-full bg-gray-50 focus:bg-white px-2 py-2 rounded-md" placeholder="20000"autofocus
                                required>
                        </div>
                        <div class="col-span-6">
                            <label for="" class=" text-neutral-800">Product Type</label>
                        ...
                        <div class="col-span-12">
                            <label for="" class=" text-neutral-800">Product Description</label>
                            <textarea type="text" name="product_description" class="w-full bg-gray-50 focus:bg-white px-2 py-2 rounded-md"></textarea>
                        </div>
                        <div class="col-span-12">
                            <label for="" class=" text-neutral-800">Product Image</label>
                            ...
                            <label for="file"
                                ...
                                <div>
                                    <input type="file" name="product_image" id="file" class="sr-only">
                                    <span
    ...
    <section class="px-5 md:px-12 lg:px-20 grid grid-cols-12 items-center gap-x-5 gap-y-4">
        @foreach ($products as $product)
            <div class="col-span-4">
                <img src="{{ $product->product_image }}" class="w-full h-52 object-cover rounded-md"
                    alt="{{ $product->product_name }}">
                <div class="mt-4 space-y-1">
                    <div class="text-lg text-black font-semibold">{{ $product->product_name }}</div>
