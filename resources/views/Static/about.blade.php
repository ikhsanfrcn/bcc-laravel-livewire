...
@section('content')
<header class="h-screen grid grid-cols-3 items-center bg-center bg-cover"
    ...
    <div class="col-start-2">
        ...
        <h1 class="pt-5 font-bold text-[5vw] text-white text-center">
            About Us
        </h1>
    </div>
</header>
...
<main class="bg-white">
    <section class="pt-32 bg-white container mx-auto">
        <div class="grid grid-cols-12 gap-x-5 md:gap-x-10 gap-y-5 md:gap-y-0 items-center">
            <div class="col-span-12 md:col-span-6">
                ...
                <p class="text-neutral-500 leading-relaxed mt-2 w-3/4">We prize quality above all else. The coffee plant
                    is
    ...
    <section class="pt-32">
        <div class="h-screen grid grid-cols-12 items-center bg-center bg-cover text-white"
            style="background-image:  linear-gradient(to bottom, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.5)), url({{ asset('img/about/dancer-2.jpg')}});">
            <div class="pt-60 col-start-2 col-span-4">
                <h5 class="text-[1.5vw]">
                    OUR MISSION
                </h5>
                <h3 class="text-[2vw] font-bold">We source coffee only from Bali, from farmers we know and trust</h3>
                <p class="pt-5 ">The global coffee industry has grown to a level that depreciates the farmer and in turn
                    the coffee
    ...
    <section class="grid grid-cols-2">
        ...
        <div class="h-screen grid grid-cols-12 items-center bg-center bg-cover"
            ...
            <div class="pt-60 col-start-2 col-span-8">
                ...
                <h3 class="text-[2vw] font-bold">Everything we do is a matter of heart, body and soul</h3>
                <p class="pt-5 ">At BCC, we love coffee. We see it as a part of our daily lives, a way to start our
    ...
    <section class="pt-32">
        <div class="h-screen bg-center bg-cover bg-fixed text-white"
            style="background-image: url({{ asset('img/about/bali-climate-mount-agung-1.png')}});">
            <div class="text-center py-20">
                <h5 class="text-[1vw]">
                    Socially Reponsible
                </h5>
                <h3 class="text-[4vw] font-bold">Our Local People</h3>
            </div>
            <div class="grid md:grid-cols-2 gap-x-20 container mx-auto place-items-center">
                <img src="{{ asset('img/about/image-23-2.jpg') }}" class="w-screen mx-auto" alt="" />
                <p class="w-full md:w-11/12">At BCC our commitment to equal opportunity means cultivating an environment
                    where
    ...
    <section class="py-32 container mx-auto grid grid-cols-2 gap-x-10">
        <img src="{{ asset('img/about/1502846833365_auto_x2-1.png') }}" class="mx-auto" alt="" />
        <div class="w-full md:w-3/4">
            <h4 class="font-bold text-[2vw]">Planet</h4>
            ...
            <h4 class="pt-12 font-bold text-[2vw]">Environmental and Social Impact Structure</h4>
