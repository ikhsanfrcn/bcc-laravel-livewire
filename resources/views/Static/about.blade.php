...
@section('content')
    ...
    <main class="py-5 md:py-12 lg:py-20 px-5 md:px-12 lg:px-20">
        <div class="grid grid-cols-12 gap-x-5 md:gap-x-10 gap-y-5 md:gap-y-0 items-center">
            <div class="col-span-12 md:col-span-6">
                ...
                <p class="text-neutral-500 leading-relaxed mt-2 w-3/4">We prize quality above all else. The coffee plant is an incredible asset to our world, and the conditions for growing coffee are unique and special. We are dedicated to being good stewards of these gifts by seeing to it that quality is delivered in every cup of BCC coffee.</p>
            </div>
            <div class="col-span-12 md:col-span-6">
