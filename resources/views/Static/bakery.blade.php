...
@section('content')
    <header class="flex items-center justify-center bg-no-repeat bg-cover bg-center h-[75vh] px-5 md:px-14 lg:px-20"style="background-image:
    ...
    <main class="py-5 space-y-10 bg-white">
        <section class="grid grid-cols-12 items-center gap-x-5 h-[50vh] md:h-screen">
            ...
            <div class="col-span-12 md:col-span-6 px-5 md:px-20">
                ...
                <h1 class="text-4xl tracking-tight font-bold">Bali Bakery</h1>
