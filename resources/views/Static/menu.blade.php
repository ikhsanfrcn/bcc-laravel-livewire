...
@section('content')
<main class="h-screen bg-neutral-100">
    <div class="max-w-2xl m-auto">
        ...
        <p class="ml-4">This carousel component is part of the <a class="text-blue-600 hover:underline"
                href="https://flowbite.com/docs/components/carousel/" target="_blank">Flowbite component library.</a>
        </p>
    </div>
</main>
@endsection