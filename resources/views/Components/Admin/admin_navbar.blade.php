<nav
    ...
    <div class="col-span-8 space-x-8 text-sm">
        ...
        <a href="/admin/subscriber" class="{{ (request()->is('admin/subscriber')) ? 'text-black' : 'text-neutral-500' }} hover:text-black transition ease-in-out duration-300">Subscribers</a>
    </div>
