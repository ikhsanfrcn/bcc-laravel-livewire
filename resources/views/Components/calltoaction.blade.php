...
<section class="py-20 lg:py-[120px]">
    <div class="container mx-auto">
      <div
        class="bg-gradient-to-r from-[#BE7656] to-[#4B1F0E] relative z-10 overflow-hidden rounded py-12 px-8 md:p-[70px]"
      >
          ...
          <div class="w-full px-4 lg:w-1/2">
            <div class="flex flex-wrap lg:justify-end">
              <a
                ...
                class="hover:text-primary my-1 mr-4 inline-block rounded bg-white bg-opacity-[15%] py-4 px-6 text-base font-medium text-white transition hover:bg-transparent md:px-9 lg:px-6 xl:px-9"
              >
                More Details
              </a>
              <a
